...
> **Note:** The name `pulse-agent` is already taken on PyPI by another project. We are evaluating alternative package names for PyPI publishing. In the meantime, install from source (see README).
